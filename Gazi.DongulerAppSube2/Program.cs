...
namespace Gazi.DongulerAppSube2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int number;
            int unumber;
        a: Console.WriteLine("Tahmin oyununa hoş geldiniz.\nBir Zorluk Düzeyi Seçiniz.\nKolay, Orta veya Zor yazabilirsiniz.");
            string? zorluk = Console.ReadLine();
            if (zorluk != null)
            {
                zorluk = zorluk.ToLower();
                if (zorluk == "kolay")
                {
                    number = rnd.Next(10);
                    tahminhakki = 10;
            ...
            Console.WriteLine($"{sayac}. tahmininizde bildiniz. Tebrikler.");
            Console.WriteLine($"Puanınız: {100 - sayac * tahminhakki}");
        }
    }
}
//Ascii
